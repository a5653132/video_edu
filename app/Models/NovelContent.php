...
class NovelContent extends Model
{
    ...
    protected $fillable = [
        'user_id', 'novel_id', 'title', 'slug',
         'view_num', 'short_description', 'content',
     ...
     */
    public function content_comments()
    {
        return $this->hasMany(NovelContentComment::class, 'novel_content_id', 'id');
    }
    ...
    {
        $comment = $this->content_comments()->save(new NovelContentComment([
            'user_id' => Auth::id(),
            'content' => $content,
        ]));
