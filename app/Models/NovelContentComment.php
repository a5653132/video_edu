 ...
 * @mixin \Eloquent
 */
class NovelContentComment extends Model
{
    use SoftDeletes, Scope;

    protected $table = 'novel_content_comments';

    protected $fillable = [
        'user_id', 'novel_content_id', 'content',
    ];
    ...
    {
        return $this->belongsTo(NovelContent::class, 'novel_content_id', 'id');
    }
