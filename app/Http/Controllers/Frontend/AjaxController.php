...
class AjaxController extends Controller
{
     ...
     * @return array
     */
    public function novelCommentHandler(CourseOrVideoCommentCreateRequest $request, $courseId)
    {
     ...
     * @return array
     */
    public function novelContentCommentHandler(CourseOrVideoCommentCreateRequest $request, $videoId)
    {
        $video = NovelContent::findOrFail($videoId);
        $comment = $video->commentHandler($request->input('content'));
        if ($comment) {
