        ...
        <div class="row row-cards">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{{old('title')}}" placeholder="文章名" required>
                </div>
                <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                @include('components.backend.image', ['name' => 'thumb', 'title' => '文章封面'])
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label><input type="radio" name="is_show" value="{{ \App\Models\Novel::SHOW_YES }}" checked>是</label>
                    <label><input type="radio" name="is_show" value="{{ \App\Models\Novel::SHOW_NO }}">否</label>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
