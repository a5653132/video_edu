...
@section('body')
    ...
    <form action="" method="post">
        ...
        <div class="row row-cards">
            <div class="col-sm-12">
                <a href="{{ route('backend.novel.index') }}" class="btn btn-primary">返回列表</a>
            </div>
            <div class="col-sm-12">
                <div class="form-group">
                    <label>文章名 @include('components.backend.required')</label>
                    <input type="text" class="form-control" name="title" value="{{$course->title}}" placeholder="文章名" required>
                </div>
                <div class="form-group">
            ...
            <div class="col-sm-6">
                ...
                @include('components.backend.image', ['name' => 'thumb', 'title' => '文章封面', 'value' => $course->thumb])
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <label><input type="radio" name="is_show"
                                  value="{{ \App\Models\Novel::SHOW_YES }}"
                                {{$course->is_show == \App\Models\Novel::SHOW_YES ? 'checked' : ''}}>是</label>
                    <label><input type="radio" name="is_show"
                                  value="{{ \App\Models\Novel::SHOW_NO }}"
                                {{$course->is_show == \App\Models\Novel::SHOW_NO ? 'checked' : ''}}>否</label>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="form-group">
