        ...
        <div class="row row-cards">
            ...
            <div class="col-sm-12">
                <div class="form-group">
                    ...
                    <select name="novel_id" class="form-control">
                        ...
                        @foreach($courses as $course)
                            <option value="{{$course->id}}" {{$video->novel_id == $course->id ? 'selected' : ''}}>{{$course->title}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="title" value="{{$video->title}}" placeholder="文章名" required>
                </div>
                {{--<div class="form-group">--}}
                ...
                <div class="form-group">
                    ...
                    @include('components.backend.editor', ['name' => 'content', 'content' => $video->content])
                </div>
            </div>
            <div class="col-sm-6">
                {{--<div class="form-group">--}}
                    ...
                    {{--<div class="input-group">--}}
                        {{--<input type="text" name="duration" class="form-control" placeholder="文章时长" value="{{$video->duration}}" required>--}}
