...
@section('content')
    ...
    <div class="title_img">
        <p class="title_sub">种一颗树最好的时间是十年前</p>
        <p class="title_sub mr_right">其次是现在</p>
        <div class="title_button"><a href="{{route('courses')}}">去课程中心学习</a></div>
    </div>
    ...
    <div class="container pt-40 pb-40">
        <div class="row">
            <div class="col-sm-12">
                <div class="divider"><a class="fs-24" href="#">最新文章</a></div>
            </div>
            <div class="col-sm-12">
                <div class="card-deck">
                    @foreach($novels as $course)
                        <div class="col-sm-4">
                            <div class="card hover-shadow-2">
                                <img class="card-img-top" src="{{ image_url($course->thumb) }}" alt="{{$course->title}}">
                                <div class="card-body">
                                    <h4 class="card-title b-0 px-0">
                                        <a href="{{ route('novel.show', [$course->id, $course->slug]) }}">{{$course->title}}</a>
                                    </h4>
                                    <p><small>最后更新：{{$course->updated_at->diffForHumans()}}</small></p>
                                </div>
                            </div>
    ...
    <div class="container-fluid pt-40 pb-40 bg-dark">
        <div class="container">
            <h5 class="study_suggestion">关于学习建议</h5>
            <p>凌晨四点半，有的人已经醒了，有的人刚刚睡着。</p>
            <p>人生四点半，有的人坚定前行，有的人依然彷徨。</p>
            <p>不行了实在编不下去了。</p>
            <p></p>
            {{--<div class="row">--}}
                {{--<div class="col-sm-12">--}}
