...
@section('base')
    ...
    <aside class="sidebar sidebar-icons-right sidebar-icons-boxed sidebar-expand-lg">
        <header class="sidebar-header">
            <span class="logo">
                <a href="{{route('backend.dashboard.index')}}" style="font-size: 2rem;">Education</a>
            </span>
        </header>
    ...
    <main>
        ...
        <footer class="site-footer">
            <div class="row">
                <div class="col-md-6">
                    <p class="text-center text-md-left">Copyright © 2019 <a href="https://meedu.vip">Education</a>. All rights reserved.</p>
                </div>
