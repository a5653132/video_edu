...
<head>
    ...
    <title>{{Auth::check() ? Auth::user()->nick_name.' - ' : ''}}{{$title ?? 'Education'}}</title>
    <!-- Styles -->
    ...
    <div class="topbar-left">
        ...
        <nav class="topbar-navigation">
            <ul class="menu">
                ...
                <li class="menu-item {{isActive('course')}}">
                    <a class="menu-link" href="{{route('courses')}}">
                        <span class="icon ti-headphone-alt"></span>
                        <span class="title">课程</span>
                    </a>
                </li>
                <li class="menu-item {{isActive('novel')}}">
                    <a class="menu-link" href="{{route('novels')}}">
                        <span class="icon ti-book"></span>
                        <span class="title">小说</span>
                    </a>
                </li>
                <li class="menu-item {{isActive('vip')}}">
...
<footer class="site-footer pt-50 pb-20">
    {{--<div class="row gap-y">--}}
        {{--<div class="col-lg-5">--}}
            ...
            {{--<p class="text-justify">--}}
                {{--Education 是一款转为个人开发的开源免费的在线点播系统。依靠 Education 可以在短短几分钟之内搭建一个功能完善的在线教育系统。Education 专注与视频--}}
                {{--的付费点播，结合数百款插件足以满足您的任何要求。--}}
            {{--</p>--}}
        {{--</div>--}}

        {{--<div class="col-6 col-md-4 col-lg-2 text-left1 text-lg-center1">--}}
            {{--<h5 class="text-uppercase fs-14 ls-1">Education</h5>--}}
    ...
    <div class="row">
        <div class="col-md-6 justify-content-center justify-content-md-start">
            <p>Copyright © 2019 <a href="https://github.com/Qsnh/meedu">Education</a>. All rights reserved.</p>
        </div>

        <div class="col-md-6">
            <ul class="nav nav-primary nav-dotted nav-dot-separated justify-content-center justify-content-md-end">
                <li class="nav-item">
                    <a class="nav-link" href="#">教育信息</a>
                </li>
                {{--<li class="nav-item">--}}
