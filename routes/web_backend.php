...
Route::group(['middleware' => ['backend.login.check']], function () {
    ...
    Route::group(['middleware' => 'backend.permission.check'], function () {
        ...
        // 文章
        Route::get('/novels', 'NovelController@index')->name('backend.novel.index');
        Route::get('/novel/create', 'NovelController@create')->name('backend.novel.create');
        Route::post('/novel/create', 'NovelController@store');
        Route::get('/novel/{id}/edit', 'NovelController@edit')->name('backend.novel.edit');
        Route::put('/novel/{id}/edit', 'NovelController@update');
        Route::get('/novel/{id}/delete', 'NovelController@destroy')->name('backend.novel.destroy');


        // 文章章节
        Route::get('/novel/{course_id}/novelchapter', 'NovelChapterController@index')->name('backend.novelchapter.index');
        Route::get('/novel/{course_id}/novelchapter/create', 'NovelChapterController@create')->name('backend.novelchapter.create');
        Route::post('/novel/{course_id}/novelchapter/create', 'NovelChapterController@store');
        Route::get('/novelchapter/{id}/edit', 'NovelChapterController@edit')->name('backend.novelchapter.edit');
        Route::put('/novelchapter/{id}/edit', 'NovelChapterController@update');
        Route::get('/novelchapter/{id}/delete', 'NovelChapterController@destroy')->name('backend.novelchapter.destroy');


        // 文章内容
        Route::get('/novel_content', 'NovelContentController@index')->name('backend.novel_content.index');
        Route::get('/novel_content/create', 'NovelContentController@create')->name('backend.novel_content.create');
        Route::post('/novel_content/create', 'NovelContentController@store');
        Route::get('/novel_content/{id}/edit', 'NovelContentController@edit')->name('backend.novel_content.edit');
        Route::put('/novel_content/{id}/edit', 'NovelContentController@update');
        Route::get('/novel_content/{id}/delete', 'NovelContentController@destroy')->name('backend.novel_content.destroy');
    ...
    Route::group(['prefix' => 'ajax', 'namespace' => 'Ajax'], function () {
        ...
        Route::get('/novel/{novel_id}/chapters', 'NovelController@chapters')->name('backend.ajax.novel.chapters');
        // 获取上传密钥
