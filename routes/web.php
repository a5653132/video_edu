...
Route::get('/novel/{novel_id}/novel_content/{id}/{slug}', 'Frontend\NovelContentController@show')->name('novel_content.show');

// 搜索
Route::get('/search', 'Frontend\SearchController@searchHandler')->name('search');
Route::get('/novel_search', 'Frontend\SearchController@novelSearchHandler')->name('novel_search');
...
Route::group([
    ...
    // 购买文章
    Route::get('/novel/{id}/buy', 'NovelController@showBuyPage')->name('member.novel.buy');
    Route::post('/novel/{id}/buy', 'NovelController@buyHandler');

    // 购买文章章节
    Route::get('/novel_content/{id}/buy', 'NovelContentController@showBuyPage')->name('member.novel_content.buy');
    Route::post('/novel_content/{id}/buy', 'NovelContentController@buyHandler');
    ...
    Route::group(['prefix' => 'ajax'], function () {
        ...
        Route::post('/novel/{id}/comment', 'AjaxController@novelCommentHandler')->name('ajax.novel.comment');
        Route::post('/video/{id}/comment', 'AjaxController@videoCommentHandler')->name('ajax.video.comment');
        Route::post('/novel_content/{id}/comment', 'AjaxController@novelContentCommentHandler')->name('ajax.novel_content.comment');
    });
});